...
function computeAccelerations() {
  ...
  function computeLennardJones(i, j, rSquared) {
  // Compute Lennard-Jones interaction for i and j particles and update i,j
  // rSquared is the square of their separation distance.
  // TODO pEatCutoff is ???
...
function paintCanvas() {
  ...
  else if (theColorOption.text == "By species") { speciesColor = true; }
  for (var i=0; i<N; i++) {
